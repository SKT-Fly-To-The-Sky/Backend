...
#     model as modellib,
#     utils)
import ai_service.food_volume_estimation_master.food_volume_estimation.food_segmentation.mrcnn.model as modellib, mrcnn.utils
...
class FoodSegmentator():
    ...
    def __init__(self, weights_path):
        ...
        self.model = modellib.MaskRCNN(mode='inference', config=config,
                                  model_dir='')
        # 수정 print('[*] Loading segmentation model weights', weights_path)
