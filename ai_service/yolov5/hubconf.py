...
def _create(name, pretrained=True, channels=3, classes=80, autoshape=True, verbose=True, device=None):
    ...
    from ai_service.yolov5.models.common import AutoShape, DetectMultiBackend
    from ai_service.yolov5.models.experimental import attempt_load
    from ai_service.yolov5.models.yolo import ClassificationModel, DetectionModel, SegmentationModel
    from ai_service.yolov5.utils.downloads import attempt_download
    from ai_service.yolov5.utils.general import LOGGER, check_requirements, intersect_dicts, logging
...
if __name__ == '__main__':
    ...
    from ai_service.yolov5.utils.general import cv2, print_args
