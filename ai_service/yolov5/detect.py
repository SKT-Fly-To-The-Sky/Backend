...
Usage - sources:
    $ python detect.py --weights yolov5s.pt --source 0                               # webcam
                                                     ...
                                                     'path/*.jpg'                    # glob
                                  r                    'https://youtu.be/Zgi9g1ksQHc'  # YouTube
...
from utils.dataloaders import IMG_FORMATS, VID_FORMATS, LoadImages, LoadScreenshots, LoadStreams, FTTSLoadImages
...
def run(
    ...
    if img0 is None:
        ...
        dataset = FTTSLoadImages(img0, img_size=imgsz, stride=stride, auto=pt, vid_stride=vid_stride)
...
def classification_supplement(img0):
    opt = parse_opt(img0=img0, weight_path='best_dru.pt')
    img, result = main(opt)
