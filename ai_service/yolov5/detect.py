...
def classification_yolov5(img0):
    try:
        ...
        parser.add_argument('--weights', nargs='+', type=str, default='.d/ai_service/yolov5/best_hoon.pt', help='model path or triton URL')
        parser.add_argument('--source', type=str, default='./ai_service/yolov5data//images', help='file/dir/URL/glob/screen/0(webcam)')
